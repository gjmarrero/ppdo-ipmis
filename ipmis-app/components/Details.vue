    ...
    <TopDrawer>
        <template #header>
            <div class="custom-header flex items-center">
                <h2 v-if="props.view_type === 'validation'" class="font-mono text-lg font-semibold">View Validation</h2>
                <h2 v-if="props.view_type === 'preengineering'" class="font-mono text-lg font-semibold">View
                    Preengineering Status</h2>
            </div>
        </template>
            ...
            <div v-for="preengineering in preEngineeringDetails" :key="preengineering.id">
                ...
                <div class="flex flex-row flex-grow max-h-[250px]">
                    <div class="w-5/6 content-center">
                        <DetailStepper :stepsMap="stepsMap" :generic_length="preengineering" />
                    </div>
...
watch(() => props.funded_project, (newProject) => {
    if (props.view_type === 'validation') {
