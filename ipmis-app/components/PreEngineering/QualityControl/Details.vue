    ...
    <TopDrawer class="max-h-[65vh] overflow-auto">
        <template #header>
            <div class="custom-header flex items-center">
                <h2 class="font-mono text-lg font-semibold">View Preengineering Status (QCP)</h2>
            </div>
        </template>
        <div>
...
<!-- 
                ...
                <div class="w-[11.5%] flex flex-col gap-6">
                    <div class="flex flex-col gap-2 items-start px-2 flex-shrink-0 w-fit">
                        <Button size="md" @click="updateQcpStatus">
...
const emit = defineEmits(['add-preengineering', 'update-qcp', 'open-activity-dialog', 'manage-other-requirements'])
